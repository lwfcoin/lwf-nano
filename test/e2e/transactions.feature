Feature: Transactions tab
  ...
  Scenario: should allow send to address
    ...
    Then I should see alert dialog with title "Success" and text "Your transaction of 1 LWF to 537318935439898807X was accepted and will be processed in a few seconds."
  ...
  Scenario: should provide "Receive LWF" modal if there are "No transactions" 
    Given I'm logged in as "empty account"
    When I click tab number 1
    And I should see table with 0 lines
    And I should see text "There are no transactions, yet.  RECEIVE LWF" in "empty message" element
